...
const CreateAppointment: React.FC = () => {
  ...
  useEffect(() => {
    api
      .get(`providers/${seletedProvider}/day-availability`, {
        params: {
  ...
  }, [selectedDate, selectedHour, seletedProvider, navigate]);
